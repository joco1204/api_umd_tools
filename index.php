...
if ($_SERVER['REQUEST_METHOD'] === 'OPTIONS') {
    // Enviar una respuesta 200 OK para solicitudes preflight de CORS
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($_SERVER['REQUEST_URI'] === '/user/login') {
        ...
        http_response_code(200);
        echo json_encode(['message' => 'hola umd tools']);
    } else {
        // Responder con error si la ruta no es /user/login ni la raíz
        http_response_code(404);
        echo json_encode(['message' => 'Ruta no encontrada']);
    }
} else {
    // Responder con error si el método no es POST ni GET
